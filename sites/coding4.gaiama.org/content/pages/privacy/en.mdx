...
changelog:
  - 2020-02-27 add info about GoatCounter
---
...
We use [GoatCounter](https://www.goatcounter.com/) as analytics provider, which is totally anonymous. The provided statistics are not as accurate as from other providers, yet it's sufficient to get an idea which pages are being visited, post are read and how often.
...
Learn more about GoatCounter from their [privacy policy](https://www.goatcounter.com/privacy).
